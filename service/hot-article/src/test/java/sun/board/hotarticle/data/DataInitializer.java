package sun.board.hotarticle.data;
...
public class DataInitializer {
    ...
    Long createArticle() {
        return articleServiceClient.post()
                .uri("/v1/articles")
                .body(new ArticleCreateRequest("title2323", "content2323", 1L, 1L))
                .retrieve()
    ...
    void like(Long articleId, long likeCount) {
        while(likeCount-- > 0) {
            likeServiceClient.post()
                    .uri("/v1/article-likes/article/{articleId}/user/{userId}/pessimistic-lock", articleId, likeCount)
                    .retrieve();
        }
    }
