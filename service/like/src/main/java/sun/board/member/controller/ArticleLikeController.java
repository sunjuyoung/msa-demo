...
import sun.board.member.service.ArticleLikeService;
...
public class ArticleLikeController {
    ...
    @GetMapping("/likes/article/{articleId}/count")
    public Long count(@PathVariable Long articleId){
        return articleLikeService.count(articleId);
    }

    @PostMapping("/likes/article/{articleId}/user/{userId}/pessimistic-lock")
    public void like(@PathVariable Long articleId, @PathVariable Long userId){
        articleLikeService.likePessmisticLock(articleId, userId);
    }

    @DeleteMapping("/likes/article/{articleId}/user/{userId}/pessimistic-lock")
    public void unlike(@PathVariable Long articleId, @PathVariable Long userId){
        articleLikeService.unlikePessmisticLock(articleId, userId);
    }
